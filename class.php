                        ...
                        if ($password === $confirmPassword) {
                            ...
                            if ($sql == true) {
                                ...
                                if (mail($to, $subject, $message)) {
                                    ...
                                    $this->email_verifieds = "We've sent a verification code to your email - $email!";
                                    header('location: EmailVerification.php');
                                    exit();
                                } else {
                                    $this->email_verified[] = "Failed while sending code!";
                                }
                            } else {
                        ...
                        if (password_verify($password, $row['password'])) {
                            ...
                            if ($row['active_status'] !== "verified") {
                                ...
                                if ($sql == true) {
                                    ...
                                    $message = "Your verification code is $activationcode";
                                    if (mail($to, $subject, $message)) {
                                        $info = "We've sent  againa verification code to your email - $email";
                                        $_SESSION['info'] = $info;
                                        $this->email_verifieds = "We've sent again a verification code to your email - $email!";
                                        header('location: EmailVerification.php');
                                        exit();
                                    } else {
                                        $this->email_verified[] = "Failed while sending code!";
                                    ...
                                    echo "Login updated failed try again!";
                                }
                            }
