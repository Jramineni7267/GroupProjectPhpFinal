...
<html lang="en">
  ...
  <body>
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <a class="nav-link  active text-white" href="product.php">
                    ...
                    <table id="example" class="table  responsive nowrap  table-responsive-sm" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-secondary btn-sm edit_data" id="<?php echo $row["id"]; ?>"  data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="fa fa-edit"></i> Update</button>
                            &nbsp;
